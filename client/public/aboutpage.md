...
This site is meant to serve as a set of programming questions, especially focusing on elementary level questions. The only thing you need for starting is the basic Python syntax, which you can learn from [any beginner resource](https://youtu.be/rfscVS0vtbw). You do not need any knowledge of data structures and algorithms, which is required for most code-solving sites such as LeetCode.
...
Unlike most sites for solving coding questions, you can view each test case for a given question. You can also check hints (if there are any) for a given question or view the solutions. You are solely responsible for how you learn from these questions.


## Suggested Learning Strategy

You are free to employ any strategy for learning from these questions. My approach would be that you are free to Google any part that you need for the solution except for the question as a whole itself. For example, if you know that you need to do x, y, z to solve a question, instead of googling the question itself, google x, y, z separately and put them together yourself.
...
Use: **[doruk.cem@gmail.com](mailto:doruk.cem@gmail.com)** to contact me.
