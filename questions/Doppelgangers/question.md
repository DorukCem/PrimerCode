...
However, the ship has become infested with **Doppelgangers** after an unfortunate accident with the Multiplier machine on deck.
...
- `crew_members`: a list of strings containing the names of each crew member.
